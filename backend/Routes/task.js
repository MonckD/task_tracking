...
router.post('/api/tasks', authenticateToken, authorize('admin', 'chef_projet'), createTask);
router.put('/api/tasks/:id', authenticateToken, updateTask);
router.delete('/api/tasks/:id', authenticateToken, authorize('admin', 'chef_projet'), deleteTask);
